...
const ICON_RADIUS = 44; // % from center â€” sits on the outer dashed ring
...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* â”€â”€â”€ TOP SECTION: HEADLINE + ORBIT â”€â”€â”€ */}
      <div className="hero-grid-container" style={{ flex: 1, display: "grid", gridTemplateColumns: "1.1fr 0.9fr", position: "relative", zIndex: 2, minHeight: 0 }}>
        ...
        >
          ...
          >
            ...
            dan eksekusi yang nyata â€” dari konsep untuk kesuksesan.
          </p>
        ...
        {/* â”€â”€â”€ RIGHT COLUMN â€” ORBIT DIAGRAM â”€â”€â”€ */}
        <motion.div
        ...
        >
          ...
          >
            ...
            {/* Connector lines + dots â€” dari badge ke middle ring */}
            <svg
              style={{
                position: "absolute",
                inset: 0,
            ...
            {divisions.map((div) => {
              ...
              return (
                ...
                >
                  {/* Badge â€” used as positioning anchor for the label */}
                  <div
        ...
        {/* Watermark "UTERO" â€” setengah terpotong di tepi kanan */}
        <span
      ...
      {/* â”€â”€â”€ BOTTOM SECTION: TICKER + STATS â”€â”€â”€ */}
          ...
          >
            {[...Array(4)].map((_, i) => (
              ...
              >
                ...
                <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "10px" }}>â--</span>
                <span style={{ fontSize: "13px", fontWeight: 700, letterSpacing: "0.12em", color: "#fff", textTransform: "uppercase" }}>
                  EVENT & AKTIVASI
                </span>
                <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "10px" }}>â--</span>
      ...
      <style>{`
        ...
        /* Orbit node group â€” wrapper for badge + label */
        .orbit-node-group {
          transition: all 0.3s var(--ease);
        }

        /* Badge (white circle) â€” also serves as positioning anchor */
        .orbit-node-badge {
          position: relative;
